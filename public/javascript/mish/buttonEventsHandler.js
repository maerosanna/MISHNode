...
function saveTimelineBtnAction() {
  if (user_loggedIn) {
    if(mishJsonObjs.timelineJson && mishJsonObjs.timelineJson.name){
      ...
      updateTimeline(function(err, updatedTimeline, expectedOperations, operationData){
        ...
        user_timelines[timelineIndex] = updatedTimeline;
        ...
        console.log("(1) user_timelines[timelineIndex].events", user_timelines[timelineIndex].events);
        ...
        supermish.timelineEvents.forEach(function(eventObj, index){
          ...
          //  mishJsonObjs.timelineJson.events.push(eventObj.storeableData);
          user_timelines[timelineIndex].events.push(eventCloned);
        });
        console.log("(2) user_timelines[timelineIndex].events", user_timelines[timelineIndex].events);
